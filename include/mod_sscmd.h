...
typedef enum 
{
    MOD_SSCMD_H1N1_SSCMD_MEDIA_SDP=1,
    MOD_SSCMD_H1N1_SSCMD_MEDIA_EX_PLAY,
    MOD_SSCMD_H1N1_SSCMD_MEDIA_EX_STOP,
    MOD_SSCMD_H1N1_SSCMD_MEDIA_NC_STATE
} MOD_SSCMD;
...
typedef enum
{
    ...
    MPD_SSCMD_STATUS_H1N1_SSCMD_MEDIA_NC_STATE,
